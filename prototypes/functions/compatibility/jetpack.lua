if mods["jetpack"] and mods["pyrawores"] and mods["pypetroleumhandling"] then
    ...
    TECHNOLOGY("jetpack-2"):set_fields {prerequisites = {"jetpack-1"}}:remove_pack("chemical-science-pack"):add_pack("py-science-pack-2"):add_prereq(mods["pyalienlife"] and "py-science-pack-2" or "logistic-science-pack")
    TECHNOLOGY("jetpack-3"):set_fields {prerequisites = {"jetpack-2"}}:remove_pack("production-science-pack"):remove_pack("py-science-pack-4"):remove_pack("utility-science-pack"):add_pack("py-science-pack-3"):add_prereq(mods["pyalienlife"] and "py-science-pack-3" or "chemical-science-pack")
