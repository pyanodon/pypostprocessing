...
-- With modifications from ***https://mods.factorio.com/mod/stdlib*** [stdlib](https://mods.factorio.com/mod/stdlib)
-- and modified to not allow nil values, and returns nil if @{pop_first} or @{pop_last} is used when the queue is empty.
-- @module Misc.Queue
-- @usage local Queue = require '__pypostprocessing__.luagraphs.queue.queue'
